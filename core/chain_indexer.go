...
func (c *ChainIndexer) Start(chain ChainIndexerChain) {
	events := make(chan types.FastChainEvent, 10)
...
// queue.
func (c *ChainIndexer) eventLoop(currentHeader *types.Header, events chan types.FastChainEvent, sub event.Subscription) {
